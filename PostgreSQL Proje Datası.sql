/* Merhaba. Bu veri setini internette buldum
ve PostgreSQL'e uyarladım. */
...
INSERT INTO unvan(unvan_ad) VALUES ('MÜHENDİS'),('İK UZMANI'),('TEKNİSYEN')

CREATE TABLE il (
il_no int PRIMARY KEY,
...
il_no int NOT NULL REFERENCES il(il_no),
